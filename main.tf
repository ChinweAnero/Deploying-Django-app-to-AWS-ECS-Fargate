...
module "policy_for_pipeline_role" {
  ...
  codebuild_projects = [module.codebuild_backend.project_arn, module.codebuild_frontend.project_arn, module.codebuild_prometheus.project_arn, module.codebuild_prometheus.project_arn]
...
module "prometheus_codedeploy" {
  source = "./Infrastructure/Modules/CodeDeploy"
  aws_lb_listener    = module.prometheus_port_listener.prometheus_listener_arn
  #module.prometheus_loadbalancer-b.listener_arn
